function love.conf(t)
	...
	t.window.width = --[[320]] 600           -- The window width (number)
	t.window.height = --[[480]] 800     -- The window height (number)
	...
	t.window.x = 2                    -- The x-coordinate of the window's position in the specified display (number)
	t.window.y = 28                 -- The y-coordinate of the window's position in the specified display (number)
